...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[--very-pale-blue] bg-[url('/bg-pattern.svg')] bg-no-repeat md:bg-[length:100%_auto] bg-[length:100%_50vh] bg-top flex flex-col items-center justify-center px-4 py-8">
      {/* Header */}
      <header className='text-center mb-20 relative -mt-20'>
        <div className="absolute -top-5 md:-top-10 opacity-70 left-1/2 -translate-x-1/2 w-[146px] h-[145px] bg-[url('/pattern-circles.svg')] -z-10"></div>
        <h1 className='text-[--dark-blue] text-[1.3rem] md:text-3xl font-extrabold mb-2 relative z-10'>
          Simple, traffic-based pricing
        </h1>
        <div className='text-[--grayish-blue] text-sm md:text-base relative z-10 flex flex-col md:block'>
      ...
      <main className='w-full max-w-xl bg-white rounded-lg shadow-lg p-6 md:p-10'>
        ...
        <div className='hidden md:flex md:flex-row items-center justify-between mb-12'>
          <p className='text-[--grayish-blue] uppercase tracking-widest text-sm md:text-[0.92rem] font-bold'>
        ...
        <div className='flex md:hidden flex-col items-center mb-3 md:mb-12'>
          <p className='text-[--grayish-blue] uppercase tracking-widest text-sm font-bold mb-4'>
            {currentTier.pageviews} Pageviews
          </p>
        </div>
        ...
        {/* Mobile Price Display - Under Slider */}
        <div className='flex md:hidden items-center justify-center mb-8'>
          <span className='text-[--dark-blue] text-4xl font-extrabold'>
            ${finalPrice.toFixed(2)}
          </span>
          <span className='text-[--grayish-blue] ml-2'>/ month</span>
        </div>
        ...
        <div className='flex items-center justify-center md:justify-end mr-0 md:mr-9 gap-4 mb-8'>
          <span className='text-[--grayish-blue] text-xs'>Monthly Billing</span>
          <div
